...
void _main(void)
{
	/*expectedInitialVAs[0]=0x200000;
	expectedInitialVAs[1]=0x201000;
	expectedInitialVAs[2]=0x202000;
	expectedInitialVAs[3]=0x203000;
	expectedInitialVAs[4]=0x204000;
	expectedInitialVAs[5]=0x205000;
	expectedInitialVAs[6]=0x800000;
	expectedInitialVAs[7]=0x801000;
	expectedInitialVAs[8]=0x802000;
	expectedInitialVAs[9]=0x803000;
	expectedInitialVAs[10]=0xeebfd000;*/
	//	cprintf("envID = %d\n",envID);
